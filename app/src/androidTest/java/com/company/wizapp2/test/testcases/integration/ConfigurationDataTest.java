package com.company.wizapp2.test.testcases.integration;
...
public class ConfigurationDataTest {
    ...
    private static String GOOD_URL = "https://hcpms-p2001156692trial.hanatrial.ondemand.com/";
